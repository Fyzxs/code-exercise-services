namespace GroceryImport.Core.DataRecords.FieldTypes
{
    ...
    public sealed class Record : IRecord
    {
        ...
        public string FieldStringValue(int startIndexOnesBased, int inclusiveEndIndexOnesBased) => _record.Substring(StartIndex(startIndexOnesBased), InclusiveEndIndex(startIndexOnesBased, inclusiveEndIndexOnesBased));

        private static int InclusiveEndIndex(int startIndexOnesBased, int inclusiveEndIndexOnesBased) => inclusiveEndIndexOnesBased - StartIndex(startIndexOnesBased);
